...
export const FooterContainer = styled.div<{ pokemon: PokemonName }>`
  ...
  background-color: ${(props) =>
    new ColorScale(0, 100, [getPokemonPaletteByPokemonName(props.pokemon).backgroundColor, '#000000']).getColor(30).toHexString()};
  color: ${(props) => getPokemonPaletteByPokemonName(props.pokemon).primaryTextColor};
`;
